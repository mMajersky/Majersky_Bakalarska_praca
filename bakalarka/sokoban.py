...
class Sokoban_Game:
    def __init__(self,level_index=0):
        ...
        self.assets = {
            "player": load_image("character/idle/character.png",1.6),
    ...
    def find_players(self):
        ...
        for row_idx, row in enumerate(self.level):
            for col_idx, tile in enumerate(row):
                if tile == "P":
                    player1 = SokobanPlayer(self, row_idx, col_idx, "P", self.assets["player"])
                elif tile == "Q":
                    player2 = SokobanPlayer(self, row_idx, col_idx, "Q", self.assets["player"])
    ...
    def load_next_level(self):
        ...
        if next_index < len(self.levels):
            ...
            pygame.quit()
            os.system("python menu.py")  # Spat do menu
            sys.exit()
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if event.key == pygame.K_ESCAPE:
                        pygame.quit()
                        os.system("python menu.py")  # Späť do menu
                        sys.exit()
